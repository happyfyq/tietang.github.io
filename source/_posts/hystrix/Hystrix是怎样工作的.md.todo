...
参考 http://youdang.github.io/2016/02/05/translate-hystrix-wiki-how-it-works/
...
<a href="http://7xiovs.com1.z0.glb.clouddn.com/hystrix-hystrix-command-flow-chart.png"> 
![](http://7xiovs.com1.z0.glb.clouddn.com/hystrix-hystrix-command-flow-chart-640.png)
...
1. <a href="#flow1">构建一个`HystrixCommand`或者 `HystrixObservableCommand` 对象</a>
1. <a href="#flow2">执行构建的`HystrixCommand`</a>
1. <a href="#flow3">是否有响应缓存?</a>
1. <a href="#flow4">回路是否打开?</a>
1. <a href="#flow5">Thread Pool/Queue/Semaphore是否达到阈值上限?</a>
1. <a href="#flow6">使用`HystrixObservableCommand.construct()` 或者 `HystrixCommand.run()`</a>
1. <a href="#flow7">计算链路健康</a>
1. <a href="#flow8">失败回退</a>
1. <a href="#flow9">返回成功响应</a>
...
第一步，创建一个 `HystrixCommand` 或者 `HystrixObservableCommand` 对象来描述你需要发给依赖服务的请求，这时，可以向构造器传递任意所需参数。

若只期望依赖服务每次返回单一的回应，按如下方式构造一个 `HystrixCommand` 即可：

如下例子，构造一个预期只返回一个单值响应[`HystrixCommand`](http://netflix.github.com/Hystrix/javadoc/index.html?com/netflix/hystrix/HystrixCommand.html) 对象 :

```java
HystrixCommand command = new HystrixCommand(arg1, arg2);
```

构造一个预期返回可监听Observable发射的数据并做出响应的[`HystrixObservableCommand`](http://netflix.github.com/Hystrix/javadoc/index.html?com/netflix/hystrix/HystrixObservableCommand.html) ，例子:
...
Hystrix command对象有四种方法执行命令，使用四种中的一个（前2种可以用于`HystrixCommand`对象，但不能用于the `HystrixObservableCommand`）：

* [`execute()`](http://netflix.github.io/Hystrix/javadoc/com/netflix/hystrix/HystrixCommand.html#execute\(\)) &mdash; 阻塞, 返回从依赖服务接收到的响应（或者抛出异常） 
* [`queue()`](http://netflix.github.io/Hystrix/javadoc/com/netflix/hystrix/HystrixCommand.html#queue\(\)) &mdash; 返回`Future`， with which you can obtain the single response from the dependency
...
<a href="http://7xiovs.com1.z0.glb.clouddn.com/hystrix-hystrix-return-flow.png">[[http://7xiovs.com1.z0.glb.clouddn.com/hystrix-hystrix-return-flow-640.png]]
_(Click for larger view)_ </a>
...
<a href="http://7xiovs.com1.z0.glb.clouddn.com/hystrix-circuit-breaker-1280.png">[[http://7xiovs.com1.z0.glb.clouddn.com/hystrix-circuit-breaker-640.png]]
_(Click for larger view)_</a>
...
[[http://7xiovs.com1.z0.glb.clouddn.com/hystrix-soa-5-isolation-focused-640.png]]
...
<a href="http://7xiovs.com1.z0.glb.clouddn.com/hystrix-request-example-with-latency-1280.png">[[http://7xiovs.com1.z0.glb.clouddn.com/hystrix-request-example-with-latency-640.png]]
_(Click for larger view)_</a>
...
<a href="http://7xiovs.com1.z0.glb.clouddn.com/hystrix-isolation-options-1280.png">[[http://7xiovs.com1.z0.glb.clouddn.com/hystrix-isolation-options-640.png]]
_(Click for larger view)_</a>
...
<a href="http://7xiovs.com1.z0.glb.clouddn.com/hystrix-thread-cost-60rps-original.png">[[http://7xiovs.com1.z0.glb.clouddn.com/hystrix-thread-cost-60rps-640.png]]
_(Click for larger view)_</a>
...
<a href="http://7xiovs.com1.z0.glb.clouddn.com/hystrix-collapser-1280.png">[[http://7xiovs.com1.z0.glb.clouddn.com/hystrix-collapser-640.png]]
_(Click for larger view)_</a>
...
<a href="http://7xiovs.com1.z0.glb.clouddn.com/hystrix-collapser-flow-1280.png">[[http://7xiovs.com1.z0.glb.clouddn.com/hystrix-collapser-flow-640.png]]
_(Click for larger view)_</a>
...
<a href="http://7xiovs.com1.z0.glb.clouddn.com/hystrix-request-cache-1280.png">[[http://7xiovs.com1.z0.glb.clouddn.com/hystrix-request-cache-640.png]]
_(Click for larger view)_</a>
